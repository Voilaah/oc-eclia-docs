...
| Action 'Place Order'          |                                           |   `(POST) /api/arcadier/invoice`  <br/>`(POST) /api/arcadier/order`  <br/>`(POST) /api/eclia/order/complete/{invoiceId}`  <br/>`(GET) /api/arcadier/email/{invoiceId}`  <br/>                         |
